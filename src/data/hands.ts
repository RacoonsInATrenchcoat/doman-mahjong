...
export const ALL_HANDS: Hand[] = [
  ...
  { id: "ryanpeikou",     name: "Ryanpeikou",             hanValue: 3,  description: "Two separate pairs of identical sequences." },
  { id: "junchan",        name: "Junchan", hanValue: 3, description: "Every set and the pair contains a terminal tile. No honours allowed." },
