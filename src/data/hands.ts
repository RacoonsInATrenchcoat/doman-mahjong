...
export const ALL_HANDS: Hand[] = [
  ...
  { id: "iipeiko",        name: "Iipeiko",                hanValue: 1,  description: "Two identical sequences in the same suit." },
  ...
  { id: "ittsu",            name: "Ittsu",              hanValue: 2,  description: "Sequences of 1-2-3, 4-5-6, and 7-8-9 in the same suit." },
